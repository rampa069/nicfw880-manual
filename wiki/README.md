...
- **[Official Releases](changelog/releases.md)** ⭐ - Stable versions (main changelog)
- [BETA Releases](changelog/beta-releases.md) - Development testing versions (BETA 01 → BETA 07C)
- [ALPHA Releases](changelog/alpha-releases.md) - Early development versions (ALPHA 12 → ALPHA 19)
...
This manual documents the **latest stable release (v5.08.01)** of nicFW880. It is compiled from official Patreon release notes and organized by function. For development versions (BETA/ALPHA), see the [Changelog](changelog/) section.
...
🎉 **Latest Stable Release:** [v5.08.01](changelog/releases.md) (November 7, 2025)
