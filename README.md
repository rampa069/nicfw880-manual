...
- **Latest Stable Release**: 🎉 **v5.08.02B** (November 28, 2025) - [Release Notes](wiki/changelog/releases.md)
- **Previous Releases**: v5.08.01, BETA 01-07C, ALPHA 12-19

> **Note**: This manual documents the **latest stable release (v5.08.02B)**. For version history, see the [changelog](wiki/changelog/).
...
This manual covers:
- ✅ Complete feature documentation for **v5.08.02B** (stable release)
- ✅ Step-by-step guides for all major features
- ✅ Troubleshooting for common issues
- ✅ Version history:
  - **Official Releases** (stable versions) - [v5.08.02B Release Notes](wiki/changelog/releases.md)
...
**Coverage**:
- **Stable release**: v5.08.02B (includes RMS Remote Protocol documentation)
- **Previous releases**: v5.08.01
