...
- The VFO assigned to APRS will be locked out from changes.
  - To now make changes to the APRS VFO you must first unassign it.
...
- Changed 'Edit Name' key from LP-GREEN to LP-0 on the GPS Waypoint browser.
...
- OSX: [Click Here](https://github.com/nicsure/nicfw880-rms-builder/)
- Windows or Linux: [Click Here](https://github.com/nicsure/nicfw880-rms-builder/)
